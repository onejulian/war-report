...
- **Enlaces (SEO):** Es fundamental y OBLIGATORIO que incluyas al pie del informe todos los enlaces REALES Y COMPLETOS de las fuentes consultadas. PROHIBIDO alucinar o inventar URLs. Cada URL debe haber sido obtenida mediante Google Search y ser 100% verídica y verificable.`
